  ...
  return (
    <ContainerLayout>
      ...
      <p className="initialLetter mb-12">
        Wenn wir schon beim Bogenschießen nichts treffen, hat Armors Pfeil
        zumindest uns erwischt! Unser Weg, der mit einem Marathon bei unserem
        ersten Date durch Köln begonnen hat, möchten wir für den Rest unseres
        Lebens fortgehen. Viele Reisen, eine Pandemie und vor allem Tanzbälle
        später, möchten wir nun den nächsten Schritt wagen und uns das Ja-Wort
        geben.
      </p>
      ...
      <p className="initialLetter mb-12">
        ...
        "Hochzeit unter Sternen" ist das Motto unseres Tages! Nach der Trauung
        werden wir mit Euch ins Franz Ferdinand flanieren, wo wir uns im Rahmen
        einer freien Trauung das Ja-Wort geben. Anschließend wird gefeiert,
        getanzt und gelacht! Wir freuen uns auf Euch!
      </p>
