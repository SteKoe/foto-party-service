...
function getDescription(plural: boolean) {
    if (plural) {
        return (
            <>
                Schön, dass ihr hier seid. Bitte füllt das Formular aus, damit
                wir wissen, ob ihr kommt und was ihr essen möchtet. Ohne zu viel
                verraten zu wollen: es gibt natürlich ein Buffet, die Vorspeise
                aber wird am Platz serviert. Daher möchten gerne wissen, welche
                Präferenzen wir berücksichtigen dürfen.
            </>
        );
    }
    ...
    return (
        <>
            Schön, dass du da bist. Bitte fülle das Formular aus, damit wir
            wissen, ob du kommst und was du essen magst. Ohne zu viel verraten
            zu wollen: es gibt natürlich ein Buffet, die Vorspeise aber wird am
            Platz serviert. Daher möchten gerne wissen, welche Präferenzen wir
