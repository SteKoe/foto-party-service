    ...
    return (
        <>
            <div className={"fixed top-1 right-1 flex gap-1 text-black"}>
                <div
                    className={"bg-white bg-opacity-50 text-center h-10 w-10 rounded flex justify-center items-center "}>
                    {isLoading ? (
                        <svg xmlns="http://www.w3.org/2000/svg" className={"animate-spin"} height="1em"
                             viewBox="0 0 512 512">
                            <path
