...
export default function ToggleFullscreenButton() {
    ...
    return (
        <button onClick={onClick}
                className={"bg-white bg-opacity-50 h-7 w-7 text-xs md:h-10 md:w-10 md:text-base rounded"}>
            {isFullscreen ? (
                <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" viewBox="0 0 512 512" className={"m-2 md:m-3"}>
                    <path
