        ...
        <form>
            ...
            <label className={styles.cameraButton} id="preview">
                ...
                {isUploading ? (
                    <div className={styles.loadingOverlay}>
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="white" className={"animate-spin m-2"}
                                 viewBox="0 0 512 512">
                                <path
            ...
            {image ? (
                <div className={styles.controls}>
                    <button type="button" className={styles.btn} onClick={submitForm} disabled={isUploading}>
                        {isUploading ? (
                            <svg xmlns="http://www.w3.org/2000/svg" fill="white" className={"animate-spin m-2"}
                                 viewBox="0 0 512 512">
                                <path
                    ...
                    <button type="reset" className={styles.btn} onClick={resetForm} disabled={isUploading}>
